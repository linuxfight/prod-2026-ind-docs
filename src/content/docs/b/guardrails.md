---
title: Guardrails - атоматический стоп эксперимента
---
...
:::caution[Важно]
Точная трактовка “rollback” должна быть единообразной в продукте. На бизнес‑уровне это означает прекращение выдачи деградирующего варианта и возвращение к базовому варианту эксперимента (control). Как именно это выражается в статусах/выдаче — реализационная деталь.
:::
