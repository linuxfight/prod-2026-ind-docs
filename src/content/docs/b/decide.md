...
description: Как продукт узнаёт “что показывать”
---
...
:::caution[Важно]
Конкретный алгоритм квот/ротации не фиксируется в ТЗ, но решение участника должно объяснять, как выполняется эта пользовательская защита.
:::
